    ...
    bind:function(){
        ...
        this.$footer.on('click','li',function(){
            ...
            EventCenter.fire('select-album',{
                chnnelId:$(this).attr('data-channel-id'),
...
var Fm = {
    ...
    loadMusic(){
        var _this=this
      $.getJSON('https://jirenguapi.applinzi.com/fm/getSong.php',{channel:this.channelId}).done(
          function(ret){
    ...
    loadLyric(){
        var _this=this
        $.getJSON('https://jirenguapi.applinzi.com/fm/getLyric.php',{sid:this.song.sid}).done(
            function(ret){   
                var lyric =ret.lyric
                var lyricObj={}
